...
class OrderLineControllerTest {
    ...
    private static Order order1 = OrderFactory.buildOrder(date1, time1, customer1, Order.OrderStatus.NEW, pizzeria);//you can change the order status if you want, to whatever
